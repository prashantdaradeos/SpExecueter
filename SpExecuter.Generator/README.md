...
# CodePiece.SpExecuter.Generator

Roslyn source generator that auto‑generates strongly‑typed, DI‑ready wrappers for your SQL Server stored procedures — no more ADO.NET boilerplate. Define your parameter and response classes, tag them with a few attributes, and let the source generator do the rest.
