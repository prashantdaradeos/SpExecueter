...
namespace SpExecuter.Generator
{
    ...
    internal sealed class SpHandler : Attribute
    {
    ...
    internal sealed class ParamConfig
    {
        ...
        public bool Unique { get; set; }//Out
        public bool ParamExclusion { get; set; }//In
        public bool ResultExclusion { get; set; }//Out
        public bool OutParam { get; set; }//In
        public int OutParamLength { get; set; }//In
    

    }
    public sealed class TVP
    {
        internal string TVPName { get; }
        internal bool IncludeInherited { get; }
    }
        internal class BaseModel
    {
        internal SourceProductionContext Context { get; set; }
        internal INamedTypeSymbol InterfaceSymbol { get; set; }
        internal IMethodSymbol MethodSymbol { get; set; }
        internal bool ExcludeIndicesClassLevel { get; set; }
        internal bool ExcludeIndicesMethodLevel { get; set; }
        internal bool UseShort { get; set; }
        public bool IsNonQuery { get; set; }
        internal bool ExcludeIndices { get; set; }
        internal HashSet<INamedTypeSymbol> UniqueTypes { get; } = new HashSet<INamedTypeSymbol>(SymbolEqualityComparer.Default);


    }
    internal class Information : BaseModel
    {
        public Information(BaseModel baseModel)
        {
            this.Context = baseModel.Context;
            this.InterfaceSymbol = baseModel.InterfaceSymbol;   
            this.MethodSymbol = baseModel.MethodSymbol;
            this.ExcludeIndicesClassLevel = baseModel.ExcludeIndicesClassLevel;
            this.ExcludeIndicesMethodLevel = baseModel.ExcludeIndicesMethodLevel;
            this.UseShort = baseModel.UseShort;
            this.IsNonQuery = baseModel.IsNonQuery;
        ...
        internal string MethodReturnTypeAsString { get; set; }
        internal string MethodName { get; set; }
        internal string StoredProcedureName { get; set; }
        internal bool AttributeAdded { get; set; }
        
        internal string SqlInParamName { get; set; }
        internal string ConnectionStringParamName { get; set; }
        internal ConditionType ConditionType { get; set; } = ConditionType.AND;
        internal int SameElementsInNestedTuple { get; set; }
        internal int SameElementsListAgnostic { get; set; }
        internal INamedTypeSymbol ReturnType { get; set; }
        internal bool BuildFailed { get; set; } = false;
        internal StringBuilder OutParams { get; set; } 
    }
    internal sealed class ConditionInfo : Information
    {
        internal ConditionInfo(Information info) : base(info)
        {
            ClassName = info.ClassName;
            NamespaceName = info.NamespaceName;
            MethodSequenceNo = info.MethodSequenceNo;
            MethodReturnTypeAsString = info.MethodReturnTypeAsString;
            MethodName = info.MethodName;
            StoredProcedureName = info.StoredProcedureName;
            AttributeAdded = info.AttributeAdded;
            SqlInParamName = info.SqlInParamName;
            ConnectionStringParamName = info.ConnectionStringParamName;
            ConditionType = info.ConditionType;
            SameElementsInNestedTuple = info.SameElementsInNestedTuple;
            ReturnType = info.ReturnType;

        }
        internal Dictionary<int, List<INamedTypeSymbol>> FlattenedReturnTypes { get;set; } 
    }
        internal class RequestProp 
    {
        internal IPropertySymbol PropertySymbol { get; set; }
        internal string DBParam { get; set; }
        internal bool ParamExclusion { get; set; } 
        internal bool OutParam { get; set; } 
        internal int OutParamLength { get; set; }

        internal string ParameterName { get; set; }

    }
    internal class ResponseProp 
    {
        internal IPropertySymbol PropertySymbol { get; set; }
        internal bool IsEnumString { get; set; }
        internal string DBParam { get; set; }
        internal bool Unique { get; set; }
        internal bool ResultExclusion { get; set; }

    }
   

}
//    internal enum LifetimeOld
//    {
//        Scoped, Singleton, Transient
//    }
//    [Generator]
//    public class SpGeneratorOld : IIncrementalGenerator
//    {
...
//                 array, registerClasses, tVPsClasses);
...
//                            paramNeeded = "true";
//                        }
//                        string returnTypes = GetReturnTypeStringForExecuter(member);
